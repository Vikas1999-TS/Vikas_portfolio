    ...
    return (
        <section id="about" className="section about">
            <div className="container">
                ...
                >
                    <p>
                        Hello! I'm Vikas T S, a Quality Assurance Engineer passionate about building reliable web and mobile experiences.
                    </p>
                    <p>
                        My journey in technology began in 2021, when I started experimenting with web development by customizing Tumblr themes. Working with HTML and CSS sparked my interest and gave me a strong understanding of how web applications are built.
                    </p>
                    <p>
