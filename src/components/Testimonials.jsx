    ...
    const testimonials = [
        {
            ...
            text: ' Vikas consistently delivered thorough test coverage that caught issues we would have otherwise missed in production. His attention to edge cases and ability to write clear, reproducible bug reports made our development cycles significantly more predictable. A true quality champion on our team',
        },
        {
            ...
            text: 'Working with Vikas was a pleasure. He doesn\'t just execute test cases — he thinks deeply about the user journey and asks the right questions during requirement reviews. His API testing skills and ability to use tools like Postman and Charles Proxy made our backend validation process much stronger.'
        }
    ];
