                ...
                <div className="footer-top">
                    <div className="footer-brand">
                        ...
                        <div className="footer-social">
                            ...
                            <a href="https://www.linkedin.com/in/vikas-t-s-a92b51229/" target="_blank" rel="noopener noreferrer" aria-label="LinkedIn">
                                <Linkedin size={18} />
                            </a>
                            <a href="mailto:vikasts9964125687@gmail.com" aria-label="Email">
                                <Mail size={18} />
                            </a>
                        </div>
                    </div>
                    ...
                    <div className="footer-contact-info">
                        ...
                        <div className="footer-contact-items">
                            ...
                            <a href="https://www.linkedin.com/in/vikas-t-s-a92b51229/" target="_blank" rel="noopener noreferrer" className="footer-contact-item">
                                <Linkedin size={15} />
                                linkedin.com/in/vikas
                            </a>
                        </div>
                    </div>
                </div>
