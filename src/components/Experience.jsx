    ...
    const experiences = [
        
        {
            ...
            description: [
                ...
                'Used tools such as ADB, logcat, Charles Proxy, Salesforce, BrowserStack, Postman, and JIRA for debugging and issue tracking.',
                ...
                'Worked on multiple projects across various domains.'
            ]
        },
        {
            company: 'Ciklum',
            ...
            description: [
                'Tested Android and Web applications, ensuring quality across multiple platforms.',
        ...
        },
        {
            ...
            description: [
                ...
                'Performed functional, regression, integration, and smoke testing across Web application.',
                'Utilized tools such as Charles Proxy, Android Studio, BrowserStack, Xcode, MySQL, AWS, and Cloudflare.',
