...
const Skills = () => {
    ...
    const skillCategories = [
        ...
        },
        {
            ...
            icon: <Server size={30} />,
            skills: ['Android Testing', 'iOS Testing', 'ADB', 'logcat', 'Charles Proxy', 'Browserstack', 'Device Compatibility']
        },
        {
            title: 'Programming & APIs',
            icon: <Database size={30} />,
            skills: ['Javascript', 'SQL', 'MySQL', 'HTML', 'CSS', 'Postman', 'Test Automation (Basics)']
        },
        {
            title: 'Tools',
            icon: <PenTool size={30} />,
            skills: ['JIRA', 'TestRail', 'BrowserStack', 'Asana', 'Jit', 'Android Studio', 'Xcode', 'Apache JMeter (Basics)']
        },
        {
            title: 'AI-Assisted Tools',
            icon: <Server size={30} />,
            skills: ['Cursor AI', 'Claude', 'DeepSeek', 'OpenAI', 'Emergent AI']
        }
    ];
